var id = 1;
var dynamicProduct = document.querySelector(".item_vessel");
var imageBox = document.querySelector(".img_full");
var productDescription = document.querySelector(".item_desc")
...
function ShowProduct() {
  ...
  fetch(productUrl)
    ...
    `
      ...
      <h3 class="subheading">${data.brand}</h3>
      <h3 class="price">Price Rs : <strong>${data.price}</strong></h3>
      <h4 class="subheading">Description</h4>
      <p class="description">
       ${data.description}
      </p>
      <h4 class="subheading">Product Preview</h4>
    ...
    `
    document.querySelector(".shopping_bag").addEventListener("click" , function(e){
      getData(data);
      setQty()
      getTotalQty()
